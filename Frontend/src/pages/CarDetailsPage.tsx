...
const CarDetailsPage = () => {
  ...
  return (
    <div className="page-shell">
      <div
        style={{ maxWidth: 1280, margin: "0 auto", padding: "24px 16px 56px" }}
      >
        ...
        {isLoading ? (
          ...
          >
            ...
            <Paragraph style={{ color: "rgba(255,255,255,0.72)" }}>
              Xe bạn đang tìm hiện tại không khả dụng hoặc đã được xoá khỏi hệ
              thống.
            </Paragraph>
              ...
              >
                <Space direction="vertical" size={18} style={{ width: "100%" }}>
                  ...
                  <div>
                    ...
                    <Text type="secondary">
                      Giá tham khảo, thanh toán khi nhận xe.
                    </Text>
                  </div>
                  ...
                  <Paragraph
                    style={{ color: "rgba(255,255,255,0.72)", marginBottom: 0 }}
                  >
                    {car.description}
                  </Paragraph>
                    ...
                    <Button
                      ...
                      icon={
                        <Heart
                          ...
                          color={isWishlisted ? "var(--color-accent)" : "white"}
                        />
                      }
